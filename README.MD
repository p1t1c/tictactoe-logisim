...
You can add images of your finished circuit here:

- `main.png` - Overview of the board.
- `logic.png` - Detail of the win gates.

---

Project created as part of Digital Logic studies.
